...
'''
Terzo metodo implementativo che, fruttando la funzione calcHarmony, genera una seconda sequenza di note ad un intervallo specificato 
'''
...
newScore2.append(note.Note(startingNoteHarmony, type=noteTypeDurations[0]))
